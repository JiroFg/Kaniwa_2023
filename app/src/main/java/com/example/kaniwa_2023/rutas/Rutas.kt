    ...
    companion object {
        ...
        fun VERDE(map: GoogleMap, context: Context){
            val polylineOptions = PolylineOptions()
                ...
                //  --------------------------------- Supuesto cambio de ruta segun erich ---------------------------------
                ...
                .add(LatLng(19.512086028175183, -96.90587374604644)).add(LatLng(19.51123974702798, -96.90487987927871))
                // ---------------------------------- INICIO ARCO SUR ----------------------------------
                .add(LatLng(19.50876876175695, -96.90230638852276)).add(LatLng(19.50783647545265, -96.9008996109273))
